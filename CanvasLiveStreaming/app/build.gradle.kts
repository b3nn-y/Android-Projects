...
android {
    namespace = "com.bennysamuel.canvaslivestreaming"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.bennysamuel.canvaslivestreaming"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
//    implementation("com.google.accompanist:accompanist-drawable:0.17.0")
    ...
    implementation("io.github.jan-tennert.supabase:serializer-moshi:2.1.3")
