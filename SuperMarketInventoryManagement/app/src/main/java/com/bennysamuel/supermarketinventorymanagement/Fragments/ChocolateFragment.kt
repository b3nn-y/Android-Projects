...
import com.bennysamuel.supermarketinventorymanagement.databinding.FragmentChocolateBinding
import com.bennysamuel.supermarketinventorymanagement.viewmodels.StocksViewModel

class ChocolateFragment : Fragment() {

    private lateinit var binding: FragmentChocolateBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentChocolateBinding.inflate(inflater,container,false)
        viewModel = ViewModelProvider(requireActivity()).get(StocksViewModel::class.java)
        savedInstanceState?.let {
            val chValue = it.getString("choco")
            if (chValue != null) {
                viewModel.setChocoValue(chValue.toInt())
            }
        }
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.back.setOnClickListener{
            findNavController().navigate(R.id.action_chocolateFragment_to_itemsFragment)
        }
        viewModel.chocoStock.observe(viewLifecycleOwner, Observer { value ->
            binding.chocoAmount.text = value.toString()
...
//            println("Inc")
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putString("choco",viewModel.chocoStock.toString())
